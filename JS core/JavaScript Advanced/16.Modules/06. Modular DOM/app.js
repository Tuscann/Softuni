...
result.TitleBar = require('./TitleBar.js');
result.Footer = require('./Footer.js');
result.Article = require('./Article.js');
result.ImageArticle = require('./ImageArticle.js');
result.TableArticle = require('./TableArticle.js');